...
void bf_write::WriteBitVectorCoord(const Vector& fa)
{
...
void bf_write::WriteBitVectorNormal(const Vector& fa)
{
	int		xflag, yflag;
...
void bf_read::ReadBitVectorCoord(Vector& fa)
{
	int		xflag, yflag, zflag;
...
void bf_read::ReadBitVectorNormal(Vector& fa)
{
