...
MAKE_HOOK(CBaseClient_Connect, S::CBaseClient_Connect(), void,
	void* rcx, const char* szName, int nUserID, INetChannel* pNetChannel, bool bFakePlayer, int clientChallenge)
{
